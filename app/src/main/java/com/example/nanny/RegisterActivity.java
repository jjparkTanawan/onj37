...
public class RegisterActivity extends AppCompatActivity {
    ...
    private String Member,nameN,genderN,ageN,mailN,passN,phoneN,lineN,saveCurrentDate,saveCurrentTime,locationN,namebN,relativeN,undisN;
    private double lati,longti;
    private EditText gender,age,mail,pass,phone,line,name,nameb,relative,undis;
...
//        Member = getIntent().getExtras().get("Member").toString();
        ...
        NannyRef = FirebaseDatabase.getInstance().getReference().child("Baby Data");
        fAuth = FirebaseAuth.getInstance();

        name=(EditText)findViewById(R.id.babyname);
        gender=(EditText)findViewById(R.id.gender2);
        age = (EditText)findViewById(R.id.age22);
        undis = (EditText)findViewById(R.id.undis2);
        nameb = (EditText)findViewById(R.id.nameb2);
        relative = (EditText)findViewById(R.id.relativeas2);
...
//        textLatlong = findViewById(R.id.textAddress);
        textAddress2 = findViewById(R.id.textAddress);
        resultReceiver = new RegisterActivity.AddressResultReceiver(new Handler());
...
//                    textLatlong.setText(String.format("Latitude: %s\nLongitude: %s",latitude,longitude));
    ...
    private void ValidateUserData() {
        ...
        genderN = gender.getText().toString();
        ageN = age.getText().toString();
        undisN = undis.getText().toString();
        namebN = nameb.getText().toString();
        relativeN = relative.getText().toString();
        ...
        if (email.matches(emailPattern)) {
            ...
            Toast.makeText(getApplicationContext(), "อีเมล์ไม่ถูฏต้อง", Toast.LENGTH_SHORT).show();
        }

        if(!TextUtils.isEmpty(mailN)&& !TextUtils.isEmpty(passN) && !TextUtils.isEmpty(genderN) &&
...
//                                Toast.makeText(addNewprofile.this, "อัปโหลดรูปภาพสำเร็จ", Toast.LENGTH_SHORT).show();
    ...
    private void savetofirebase(){
        ...
        location_b = new location(lati,longti,locationN);
        member = new Baby(id,nameN,ageN,genderN,undisN,namebN,relativeN,mailN,passN,phoneN,lineN,dowloadImageUri,location_b,condition_b,welfere_b);
...
//                        Toast.makeText(addNewprofile.this, "User Authen", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(getApplicationContext(), notification1Activity.class));
