...
public class itemnoti2 extends AppCompatActivity {

    private DatabaseReference databaseReference,databaseReference2,databaseReference3;

    private String uid,uidn,namenanny;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        databaseReference3 = FirebaseDatabase.getInstance().getReference("Requst");
        ...
        cencel = findViewById(R.id.cancel2);
        ...
        cencel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Query q1 = databaseReference3.orderByChild("baby_uid").equalTo(uid);
                        ...
                        for(DataSnapshot dataSnapshot1: dataSnapshot.getChildren()){
                            if(dataSnapshot1.child("baby_uid").getValue(String.class).equals(uidbabyc)){
                                if(dataSnapshot1.child("nanny_uid").getValue(String.class).equals(uidn)){
                                    ...
                                    Intent intent = new Intent(itemnoti2.this, notification1Activity.class);
